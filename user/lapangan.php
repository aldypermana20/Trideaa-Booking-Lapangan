...
<body class="index-page">
  ...
  <main class="main">
    ...
    <div class="page-title" data-aos="fade">
      <img src="../img/ruble-bg.jpg" alt="">
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <p class="heading" style="padding-top: 200px;" class="mb-0"></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row gy-4">
      ...
      <div class="col-6 col-lg-4 col-md-6 footer-about">
        ...
        <div class="footer-contact pt-3">
          <p>Trideaa Futsal</p>
          <p>Indonesia</p>
          <a href="https://wa.me/6282125349983" style="color: black;">
            <strong>Whatsapp:</strong> <span>+62 831-2534-9983</span>
          </a>
          <p style="color: black;">
            <strong>Email:</strong> <span>tridea@gmail.com</span>
          </p>
        </div>
