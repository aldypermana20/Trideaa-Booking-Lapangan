...
<div class="mb-5" data-aos="fade-up" data-aos-delay="200">
  <iframe style="border:0; width: 100%; height: 300px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.700106554409!2d107.70848047356553!3d-6.926405567793586!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68c2d463392635%3A0x31f79678a57c002c!2sZone%2073!5e0!3m2!1sid!2sid!4v1747409813975!5m2!1sid!2sid" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  ...
  <div class="row gy-4">
    ...
    <div class="col-lg-4">
      <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
        ...
        <div>
          <h3>Address</h3>
          <p>Jl. AH. Nasution No.73, Cipadung, Kec. Cibiru, Kota Bandung, Jawa Barat 40614</p>
        </div>
      </div><!-- End Info Item -->
      ...
      <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="400">
        ...
        <div>
          <h3>Call Us</h3>
          <a href="https://wa.me/6282125349983" target="_blank">Hubungi via WhatsApp</a>
        </div>
      </div><!-- End Info Item -->
    ...
    <div class="col-lg-8">
      <form class="php-email-form" data-aos="fade-up" data-aos-delay="200" id="chatWa">
        <div class="row gy-4">

          <div class="col-md-12">
            <input type="text" name="name" id="nama" class="form-control rounded" placeholder="Nama Lengkap" required="">
  </div>

          <div class="col-md-12">
            <textarea class="form-control rounded" id="pesan" name="message" rows="6" placeholder="Pesan" required=""></textarea>
          </div>
    ...
    <script>
      document.getElementById("chatWa").addEventListener("submit", function(e){
        e.preventDefault();

        var nama = document.getElementById("nama").value;
        var pesan = document.getElementById("pesan").value;

        var teks = `Nama Pengirim Pesan :${nama} \n\n\npesan\n ${pesan}`;
        var url = `https://wa.me/6282125349983?text=${encodeURIComponent(teks)}`;
