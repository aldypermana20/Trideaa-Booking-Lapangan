...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="img/ruble-bg.jpg" alt="" data-aos="fade-in">
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-1 order-lg-2 my-auto" data-aos="fade-up" data-aos-delay="100">
            <img src="img/ruble-bg.jpg" class="img-fluid" alt="">
          </div>

          <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
            <h3>Trideaa</h3>
            <p class="fst-italic">
              Tempat Terbaik untuk Aksi Terbaik Anda.
            </p>
            <ul>
               <li><i class="bi bi-check-circle"></i> <span>Rasakan serunya bermain futsal di lapangan premium kami yang dirancang untuk kenyamanan dan performa maksimal.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Lapangan futsal berstandar profesional dengan permukaan terbaik untuk permainan yang cepat dan aman.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Pencahayaan optimal untuk permainan siang maupun malam hari.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Fasilitas lengkap dan bersih, termasuk ruang ganti, loker, dan area istirahat.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Sewa fleksibel harian atau mingguan, cocok untuk latihan rutin hingga turnamen komunitas.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Lokasi strategis dan akses mudah, pas untuk Anda yang ingin tetap aktif tanpa ribet.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Trideaa Futsal, bukan sekadar tempat bermain – tapi tempat membangun semangat tim dan gaya hidup sehat.</span></li>
      ...
      <div class="row gy-4">
        <div class="col-6 col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">Trideea</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Trideaa Futsal</p>
            <p>Indonesia</p>
            <p class="mt-3"><strong>Whatsapp:</strong> <span>+62 831-2534-9983</span></p>
            <p><strong>Email:</strong> <span>tridea@gmail.com</span></p>
          </div>
